            ...
            <div>
              <div><a class="logo text-start" href="index.html">
                <div class="d-flex justify-content-center">
                    ...
                    <img style="width:80%" class="img-fluid for-light" src="images/logo/logo-techthink-hub-indonesia.png" alt="looginpage">
                    {{-- <img class="img-fluid for-dark" src="images/logo/logo_dark.png" alt="looginpage"></a></div> --}}
                </div>
