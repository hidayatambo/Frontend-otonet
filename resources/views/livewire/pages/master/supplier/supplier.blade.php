            ...
            <div class="card">
                <div class="card-header pb-0 card-no-border">
                    <button class="btn btn-success" type="button" data-bs-toggle="modal"
                        data-bs-target="#supplierModal" style="display: block;">Tambah Data</button>
                    @if ($isOpen === true)
                    <div class="modal show fade" tabindex="-1" role="dialog" style="display: block;" id="supplierModal">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-1">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        value="{{ $detail['alamat'] ? $detail['alamat'] : '' }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-1">
                                                ...
                                                <div class="form-group row mb-1">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        value="{{ $detail['kontak'] ? $detail['kontak'] : '' }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-1">
                                                ...
                                                <div class="form-group row mb-1">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        value="{{ $detail['no_rekening'] ? $detail['no_rekening'] : '' }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-1">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        value="{{ $detail['nama_bank'] ? $detail['nama_bank'] : '' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
