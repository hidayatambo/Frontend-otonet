<div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header pb-0 card-no-border">
                    ...
                    @if ($isOpen === true)
                    <div class="modal fade show" tabindex="-1" role="dialog" style="display: block;" id="orderPembelianPartModal">
    ...
    <script>
        window.onclick = function(event) {
            let modal = document.getElementById('orderPembelianPartModal');
