                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            <li class="back-btn"><a href="index.html"><img class="img-fluid"
                                        src="{{ url('') }}images/logo/logo-icon.png" alt=""></a>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                                <label class="badge badge-light-primary">8</label><a class="sidebar-link sidebar-title"
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-home"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-home"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-widget"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-widget"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-layout"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-layout"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"> </i>
                                <label class="badge badge-light-secondary">New</label><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-project"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-project"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-file"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-file"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                                <label class="badge badge-light-danger">Latest </label><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-board"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-board"></use>
                                    </svg><span>kanban Board</span></a>
                            </li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-ecommerce"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-ecommerce"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-email"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-email"></use>
                                    </svg><span>Letter Box</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-chat"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-chat"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-user"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-user"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-bookmark"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-bookmark"> </use>
                                    </svg><span>Bookmarks</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="contacts.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-contact"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-contact"> </use>
                                    </svg><span>Contacts</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="task.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-task"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-task"> </use>
                                    </svg><span>Tasks</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-calendar"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-calender"></use>
                                    </svg><span>Calendar</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="social-app.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-social"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-social"> </use>
                                    </svg><span>Social App</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="to-do.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-to-do"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-to-do"> </use>
                                    </svg><span>To-Do</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="search.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-search"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-search"> </use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-form"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-form"> </use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-table"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-table"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-ui-kits"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-ui-kits"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-bonus-kit"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-bonus-kit"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-animation"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-animation"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-icons"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-icons"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-button"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-botton"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-charts"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-charts"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-landing-page"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-landing-page"></use>
                                    </svg><span>Landing page</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="sample-page.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-sample-page"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-sample-page"></use>
                                    </svg><span>Sample page</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="internationalization.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-internationalization">
                                        </use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-internationalization">
                                        </use>
                                    </svg><span>Internationalization</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav"
                                    href="{{ url('') }}starter-kit/index.html" target="_blank">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-starter-kit"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-starter-kit"></use>
                                    </svg><span>Starter kit</span></a></li>
                            <li class="mega-menu sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-others"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-others"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-gallery"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-gallery"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-blog"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-blog"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-faq"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-faq"></use>
                                    </svg><span>FAQ</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-job-search"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-job-search"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-learning"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-learning"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-maps"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-maps"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title" href="#">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-editors"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-editors"></use>
                            ...
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-knowledgebase"></use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-knowledgebase"></use>
                                    </svg><span>Knowledgebase</span></a></li>
                            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="support-ticket.html">
                                    <svg class="stroke-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#stroke-support-tickets">
                                        </use>
                                    </svg>
                                    <svg class="fill-icon">
                                        <use href="{{ url('') }}svg/icon-sprite.svg#fill-support-tickets"></use>
                ...
                <div class="row widget-grid">
                        ...
                        <div class="card profile-box">
                            <div class="card-body">
                                <div class="media media-wrapper justify-content-between">
                                    <div class="media-body">
                                        <div class="greeting-user">
                                            ...
                                            <div class="whatsnew-btn"><a class="btn btn-outline-white">Whats New !</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <div class="cartoon"><img class="img-fluid"
                                        src="{{ url('') }}images/dashboard/cartoon.svg"
                                    ...
                                    <div class="card-body">
                                        <div class="widget-content">
                                            <div class="widget-round secondary">
                                                <div class="bg-round">
                                                    <svg class="svg-fill">
                                                        <use href="{{ url('') }}svg/icon-sprite.svg#cart"> </use>
                                                    </svg>
                                                    <svg class="half-circle svg-fill">
                                                        <use href="{{ url('') }}svg/icon-sprite.svg#halfcircle">
                                                        </use>
                                                    </svg>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="widget-content">
                                                <div class="widget-round primary">
                                                    <div class="bg-round">
                                                        <svg class="svg-fill">
                                                            <use href="{{ url('') }}svg/icon-sprite.svg#tag">
                                                            </use>
                                                        </svg>
                                                        <svg class="half-circle svg-fill">
                                                            <use
                                                                href="{{ url('') }}svg/icon-sprite.svg#halfcircle">
                                                            </use>
                                                        </svg>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-content">
                                            <div class="widget-round warning">
                                                <div class="bg-round">
                                                    <svg class="svg-fill">
                                                        <use href="{{ url('') }}svg/icon-sprite.svg#return-box">
                                                        </use>
                                                    </svg>
                                                    <svg class="half-circle svg-fill">
                                                        <use href="{{ url('') }}svg/icon-sprite.svg#halfcircle">
                                        ...
                                        <div class="card-body">
                                            <div class="widget-content">
                                                <div class="widget-round success">
                                                    <div class="bg-round">
                                                        <svg class="svg-fill">
                                                            <use href="{{ url('') }}svg/icon-sprite.svg#rate">
                                                            </use>
                                                        </svg>
                                                        <svg class="half-circle svg-fill">
                                                            <use
                                        ...
                                        <div class="row g-sm-4 g-2">
                                            <div class="col-xl-12 col-md-4">
                                                <div class="light-card balance-card widget-hover">
                                                    <div class="svg-box">
                                                        <svg class="svg-fill">
                                                            <use href="{{ url('') }}svg/icon-sprite.svg#income">
                                                            </use>
                                                        </svg>
                                                    </div>
                                            ...
                                            <div class="col-xl-12 col-md-4">
                                                <div class="light-card balance-card widget-hover">
                                                    <div class="svg-box">
                                                        <svg class="svg-fill">
                                                            <use href="{{ url('') }}svg/icon-sprite.svg#expense">
                                                            </use>
                                                        </svg>
                                                    </div>
                                            ...
                                            <div class="col-xl-12 col-md-4">
                                                <div class="light-card balance-card widget-hover">
                                                    <div class="svg-box">
                                                        <svg class="svg-fill">
                                                            <use
                                                                href="{{ url('') }}svg/icon-sprite.svg#doller-return">
                                                            </use>
                                                        </svg>
                                                    </div>
                                    ...
                                    <li class="d-flex">
                                        ...
                                        <div class="w-100 ms-3">
                                            <p class="d-flex justify-content-between mb-2"><span
                                                    class="date-content light-background">8th March, 2022 </span><span>1
                                                    day ago</span></p>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle"
                                                            src="{{ url('') }}images/dashboard/user/1.jpg"
                                                            alt="user"></td>
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle"
                                                            src="{{ url('') }}images/dashboard/user/2.jpg"
                                                            alt="user"></td>
                                                    <td class="img-content-box"><a class="d-block f-w-500"
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle"
                                                            src="{{ url('') }}images/dashboard/user/3.jpg"
                                                            alt="user"></td>
                                                    <td class="img-content-box"><a class="d-block f-w-500"
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle"
                                                            src="{{ url('') }}images/dashboard/user/4.jpg"
                                                            alt="user"></td>
                                                    <td class="img-content-box"><a class="d-block f-w-500"
                                                ...
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle"
                                                            src="{{ url('') }}images/dashboard/user/5.jpg"
                                                            alt="user"></td>
                                                    <td class="img-content-box"><a class="d-block f-w-500"
                    ...
                    <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
                        <div class="card purchase-card"><img class="img-fluid"
                                src="{{ url('') }}images/dashboard/purchase.png" alt="vector mens with leptop">
                    ...
                    <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                        <div class="card papernote-wrap">
                            ...
                            <div class="card-body pt-0"> <img class="banner-img img-fluid"
                                    src="{{ url('') }}images/dashboard/papernote.jpg"
                                        ...
                                        <div class="customers">
                                            <ul>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                        ...
                                                        alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                        src="{{ url('') }}images/dashboard/user/6.jpg"
                                                        alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                        src="{{ url('') }}images/dashboard/user/7.jpg"
                                                        alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                        src="{{ url('') }}images/dashboard/user/3.jpg"
                                                        alt="user"></li>
                                                <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                        src="{{ url('') }}images/dashboard/user/8.jpg"
                                                        alt="user"></li>
