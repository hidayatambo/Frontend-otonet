                ...
                <div class="card profile-box">
                    <div class="card-body">
                        ...
                        <div class="cartoon"><img class="img-fluid"
                                src="{{ url('') }}images/dashboard/cartoon.svg" alt="vector women with leptop">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row g-sm-4 g-2">
                                    ...
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use href="{{ url('') }}svg/icon-sprite.svg#doller-return">
                                                    </use>
                                                </svg>
                                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ url('') }}images/dashboard/user/1.jpg" alt="user">
                                            </td>
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ url('') }}images/dashboard/user/2.jpg" alt="user">
                                            </td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ url('') }}images/dashboard/user/3.jpg" alt="user">
                                            </td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ url('') }}images/dashboard/user/4.jpg" alt="user">
                                            </td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
                                        ...
                                        <tr>
                                            <td><img class="img-fluid img-40 rounded-circle"
                                                    src="{{ url('') }}images/dashboard/user/5.jpg" alt="user">
                                            </td>
                                            <td class="img-content-box"><a class="d-block f-w-500"
            ...
            <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                <div class="card papernote-wrap">
                    ...
                    <div class="card-body pt-0"> <img class="banner-img img-fluid"
                            src="{{ url('') }}images/dashboard/papernote.jpg" alt="multicolor background">
                                ...
                                <div class="customers">
                                    <ul>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ url('') }}images/dashboard/user/1.jpg" alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ url('') }}images/dashboard/user/6.jpg" alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ url('') }}images/dashboard/user/7.jpg" alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ url('') }}images/dashboard/user/3.jpg" alt="user"></li>
                                        <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                src="{{ url('') }}images/dashboard/user/8.jpg" alt="user"></li>
