(function ($) {
  $(document).ready(function () {
    ...
    $("#data-source-4").DataTable({
      ...
      ajax: "../admin/json/server-side.json",
    });
    ...
    $("#ajax-data-nested-object").DataTable({
      processing: true,
      ajax: "../admin/ajax/object_nested.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#orthogonal-data").DataTable({
      ajax: "../admin/ajax/orthogonal.txt",
      columns: [
        {
          data: "name",
        },
    ...
    $("#server-side-datatable").DataTable({
      processing: true,
      serverSide: true,
      ajax: "../admin/ajax/server-processing.php",
    });
    ...
    $("#datatable-http").DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "../admin/ajax/server-processing.php",
        data: function (d) {
          d.myKey = "myValue";
        },
      },
